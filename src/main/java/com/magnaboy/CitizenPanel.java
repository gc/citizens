...
class CitizenPanel extends PluginPanel {
    ...
    private JTextArea runeMonkPasteArea;
    ...
    private void addEditorComponents(JPanel layoutPanel) {
        ...
        //RuneMonk Paste
        {
            ...
            gbc.gridy++;
            runeMonkPasteArea = new JTextArea(8, 2);
            runeMonkPasteArea.setLineWrap(true);
            JScrollPane scroll = new JScrollPane(runeMonkPasteArea, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
            createLabeledComponent(scroll, "Paste From RuneMonk", layoutPanel, gbc);
        }
    }
